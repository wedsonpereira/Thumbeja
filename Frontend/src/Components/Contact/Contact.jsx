...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        const data = {
            ...
            email: formData.get('email'),           // ✅ Email from email field
            business: formData.get('company'),      // ✅ Business from company field
            contact: formData.get('phoneNumber'),   // ✅ Contact from phone field
