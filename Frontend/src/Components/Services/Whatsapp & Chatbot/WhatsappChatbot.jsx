...
const WhatsappChatbot = () => {
    ...
    return (
        <div className="whatsapp-chatbot-page bg-[#fefdf7] min-h-screen pt-24">
            <SEO
                title="WhatsApp Business API & Chatbot Services in Mangalore | Thumbeja Publicity"
                description="AI-powered WhatsApp Business API, chatbot, bulk SMS, and email marketing automation services in Mangalore, Karnataka for 24/7 customer engagement and lead generation."
                keywords="WhatsApp Business API Mangalore, chatbot services Mangalore, AI chatbot, bulk SMS Mangalore, email marketing Mangalore, customer support automation, WhatsApp marketing Karnataka"
            ...
            <div className="max-w-[1200px] m-auto px-8 py-16 whatsapp-animation-1">
                <h1 className="text-5xl font-bold text-[#091e42] mb-6">WhatsApp & ChatBot Solutions in Mangalore</h1>
