...
const CustomerRelationshipManagement = () => {
    ...
    return (
        <div className="DigitalMarketing max-width-[2000px] min-h-[60rem]">
            ...
            <div className="max-w-[1200px] m-auto px-8 py-6 mb-8 crm-animation-2">
            ...
            <div className="points max-w-300 pl-14 m-auto  pt-6 leading-6 crm-animation-5" >
                <ul className="services-list" >
            ...
            <div className="4th para max-w-300  m-auto crm-animation-6">
                <h1 className="subheading pt-[1.5rem] pl-[2.5rem]"
