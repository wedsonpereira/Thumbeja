...
import { services1, services2, services3 } from "../../../assets/JsonData/Servicesdata/CRM.js";
    ...
    return (
        <div className="DigitalMarketing max-width-[2000px] min-h-[60rem] pt-24">
            ...
            <div className="DigitalMarketingbox1 max-w-300  m-auto crm-animation-1">
                ...
                <p className="paragraph1 leading-8 pl-[1.5rem] " style={{ textAlign: 'left' }}>We at Thumbeja Publicity offer a comprehensive Customer Relationship Management (CRM) approach to managing your interactions with current and potential customers, leveraging data-driven strategies to enhance customer satisfaction and loyalty.</p>
            ...
            <div className="crm-animation-3">
                <p className="paragraph1 leading-8 pl-[1.5rem] max-w-300  m-auto" style={{ textAlign: 'left' }}>Our effective CRM implementation helps your business streamline its sales processes, improve customer service, and boost retention rates by delivering tailored experiences that anticipate your customers' needs and resolve issues proactively.</p>
            </div>
            ...
            <div className="DigitalMarketingbox2 max-w-300  m-auto crm-animation-5">
                ...
                <p className="paragraph1 leading-8 pl-[1.5rem] " style={{ textAlign: 'left' }}>At Thumbeja Publicity, our CRM services empower your business to build stronger customer connections through integrated platforms that centralize data, automate interactions, and provide real-time insights for informed decision-making across your sales, marketing, and support teams.</p>
            </div>
            ...
            <div className="Subheadingmain max-w-300  m-auto crm-animation-6">
                ...
                <p className="paragraph1 leading-8 pl-[1.5rem] pt-2" style={{ textAlign: 'left' }}>Our tailored CRM strategies include everything from lead nurturing and customer segmentation to performance tracking and feedback loops, all designed to maximize your customer lifetime value and drive sustainable revenue growth.</p>
                <div className="max-w-[900px] m-auto px-8 py-6 mb-8">
            ...
            <div className="4th para max-w-300  m-auto crm-animation-offer">
                ...
                <p className="paragraph1 leading-8 pl-[1.5rem] pt-3" style={{ textAlign: 'left' }}>We deliver end-to-end CRM solutions customized for businesses seeking to optimize customer engagement and operational efficiency. From deploying advanced CRM software like Salesforce or HubSpot integrations to developing custom dashboards and automation workflows, we ensure your systems support scalable growth while maintaining data security and compliance.</p>
