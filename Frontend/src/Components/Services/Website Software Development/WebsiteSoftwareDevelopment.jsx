...
const WebsiteSoftwareDevelopment = () => {
    ...
    return (
        <div className="website-development-page bg-[#fefdf7] min-h-screen pt-24">
            <SEO
                title="Website & Software Development in Mangalore - Custom Web Solutions | Thumbeja"
                description="Professional website and software development services in Mangalore, Karnataka. Thumbeja Publicity builds responsive websites, e-commerce platforms, mobile apps, SEO-friendly websites, and custom business applications."
                keywords="website development Mangalore, web design Mangalore, e-commerce development Mangalore, mobile app development Mangalore, custom software Mangalore, SEO-friendly websites, best web development company Mangalore, software development Karnataka"
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8 py-8 md:py-16 website-animation-1">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#091e42] mb-4 md:mb-6">Website & Software Development in Mangalore</h1>
