        ...
        sections:[
            {
                ...
                items: [
                    {
                        subHeading: "1. Software Development",
                        points: [
                            "Develop and maintain custom web applications, portals, and software solutions.",
                            "Write clean, efficient, and maintainable code following company coding standards."
                        ]
                    },
                    {
                        subHeading: "2. Website Development & Maintenance",
                        points: [
                            "Work on domain setup, hosting, server configurations, and deployment of websites.",
                            "Ensure websites are responsive, SEO-friendly, and optimized for maximum reach."
                        ]
                    },
                    {
                        subHeading: "3. Collaboration & Support",
                        points: [
                            "Work closely with Graphic Designers, App Developers, and Digital Marketing Experts to integrate designs and functionalities.",
                            "Provide technical support to clients when required."
                        ]
                    },
                    {
                        subHeading: "4. Testing & Quality Assurance",
                        points: [
                            "Conduct unit testing, debugging, and troubleshooting for all projects.",
                            "Ensure data security, speed, and reliability of applications."
                        ]
                    },
                    {
                        subHeading: "5. Documentation",
                        points: [
                            "Maintain proper technical documentation, version control, and backups for each project."
                        ]
                    },
                    {
                        subHeading: "6. API Integration & Development",
                        points: [
                            "Integrate WhatsApp Business API with CRM/ERP systems and marketing platforms.",
                            "Implement SMS DLT compliance systems for client notifications and alerts.",
                            "Integrate Payment Gateways (Razorpay, PayU, Paytm, etc.) with secure transaction workflows.",
                            "Develop modules for Aadhaar-PAN validation and KYC processes using government-approved APIs."
                        ]
                    },
                    {
                        subHeading: "7. System Architecture & Backend Development",
                        points: [
                            "Design scalable backend services (Node.js, Python, PHP, or Java).",
                            "Ensure API integrations are secure, optimized, and error-handled.",
                            "Build RESTful APIs for internal and external system use."
                        ]
                    },
                    {
                        subHeading: "8. Database Management",
                        points: [
                            "Manage structured/unstructured databases (MySQL, MongoDB, PostgreSQL).",
                            "Create tables and procedures to store API response data securely."
                        ]
                    },
                    {
                        subHeading: "9. Testing & Debugging",
                        points: [
                            "Conduct unit testing, integration testing, and user acceptance testing (UAT).",
                            "Debug issues related to API response, latency, and security compliance."
                        ]
                    },
                    {
                        subHeading: "10. Documentation & Compliance",
                        points: [
                            "Prepare technical documentation for all integrations.",
                            "Ensure compliance with RBI, UIDAI, TRAI (DLT), and Data Privacy Regulations."
                        ]
                    },
                    {
                        subHeading: "11. Collaboration & Support",
                        points: [
                            "Work closely with Digital Marketing, Sales, and Client Teams to implement integrations.",
                            "Provide post-deployment support and handle troubleshooting."
                        ]
                    }
                ]
            },
            {
                ...
                points: [
                    "Proficiency in HTML5, CSS3, JavaScript, PHP, Python, Node.js, React, or Angular.",
                    "Experience with databases (MySQL, MongoDB, PostgreSQL).",
                    "Knowledge of server management, hosting, and cloud platforms.",
                    "Understanding of SEO, security practices, and cross-browser compatibility.",
                    "Proficiency in API integration (REST, SOAP, JSON, XML).",
                    "Strong knowledge of WhatsApp Business API, SMS DLT Platforms.",
                    "Experience with Payment Gateway integrations (Razorpay, PayU, Stripe, Paytm, etc.).",
                    "Knowledge of UIDAI Aadhaar API, NSDL PAN verification API.",
        ...
        sections: [
            ...
            },
            {
                ...
                points: [
                    ...
                    "Good understanding of market research and sales strategies.",
                    "Analytical skills for identifying trends and business opportunities.",
